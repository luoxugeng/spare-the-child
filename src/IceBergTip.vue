<template>
    <div id="iceBergTip">
        ...
        <div class="mv5">
            ...
            <p class="rtecenter" style="line-height: 20.8px; text-align: center;">
                <img alt="Graphic demonstrating that out of 1000 sexual assaults, 995 perpetrators will walk free. Out of every 1,000 rapes, 310 are reported to the police, 57 reports lead to arrest, 13 cases get referred to prosecutors, 7 cases will lead to a felony conviction, 6 rapists will be incarcerated."
                     height="1185" src="https://nemolaw.s3.amazonaws.com/blog/Out_Of_1000_SexualAssaults_053019.png" style="width: 600px; height: 494px; background-color: white;margin: 0 auto;" align="middle"  width="1200" />
            </p>
<!--            <div class="w-50-l h-25 w-40-ns ml-0 ml-5-ns white georgia f4 lh-copy  dib v-top" style="height:600px;float:left;">-->
            <p class="white teko-body f3 w-100    db mv5" > 这是来自美国<a href="https://www.rainn.org/statistics/criminal-justice-system" style="color: aqua">司法系统</a>的统计数据:
               ...
               <a>也就是说，从侵害到选择报案，已经有75%的被害人选择默默忍受. <a style="color: red">社会需要对受害者包容，让她们更有勇气</a></a><br>
                ...
                三聚氰胺毒奶粉受害入院的儿童有40,000+,这还只是官方的数据.这么大的案件，诉讼照理都会公开，文书上以个人名义起诉的,我没看到.网上能搜到的是 <a href="https://zh.wikipedia.org/wiki/%E9%83%AD%E5%88%A9" style="color: aqua" >郭利案</a>.郭利的维权打了9年，搭进去自己5年牢狱生后面才改判无罪.这个正义来得有点晚
            </p>
